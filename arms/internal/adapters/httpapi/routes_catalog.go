...
func routeCatalog() []RouteEntry {
	return []RouteEntry{
		...
		{"GET", "/api/gateway-endpoints", "List gateway connection profiles (driver, url, token, …)"},
		{"POST", "/api/gateway-endpoints", "Create gateway profile {driver: stub|openclaw_ws|nullclaw_ws|nullclaw_a2a|picoclaw_ws|zeroclaw_ws, gateway_url, optional display_name, gateway_token, device_id, timeout_sec, product_id}"},
