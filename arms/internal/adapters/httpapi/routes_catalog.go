...
func routeCatalog() []RouteEntry {
	return []RouteEntry{
		...
		{"POST", "/api/gateway-endpoints", "Create gateway profile {driver: stub|openclaw_ws|nullclaw_ws|nullclaw_a2a|picoclaw_ws|zeroclaw_ws|mimiclaw_ws|nanobot_cli|zclaw_relay_http, gateway_url, optional display_name, gateway_token, device_id, timeout_sec, product_id}"},
