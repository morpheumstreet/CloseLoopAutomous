...
import { CreateResearchHubModal } from '../components/system/CreateResearchHubModal';
...
export function ResearchClawHubsPanel({ client }: { client: ArmsClient }) {
  ...
  return (
    <div className="ft-queue-flex" style={{ flex: 1, minWidth: 0, minHeight: 0, padding: '0.75rem', overflow: 'auto' }}>
      <div className="ft-docs-page">
        ...
        <ResearchClawHubsPanel client={client} />
